...
Examples:
  * `python main.py --model SVM --dataset IndianPines --training_sample 30`
  ...
  * `python main.py --model nn --dataset PaviaU --training_sample 10 --cuda`
  ...
  * `python main.py --model hamida --dataset PaviaU --training_sample 50 --patch_size 7 --epoch 50 --cuda`
